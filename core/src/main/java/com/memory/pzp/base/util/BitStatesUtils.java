...
public class BitStatesUtils {
	...
	public final static Long OP_BIND_BASIC = 1L << 2; // 用户填写基本资料
	public final static Long OP_BIND_REALAUTH = 1L << 3;//用户身份认证
	public final static Long OP_BIND_VEDIOAUTH = 1L << 4;// 用户视频认真

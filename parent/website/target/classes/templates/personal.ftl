                    ...
                    if(phoneNumber){
                        $.ajax({
                            ...
                            success:function (data) {
                                console.log(data);
                                if(data.success){
                                    oneself.attr("disabled",true);
                                    var count = 5;
                                    var time = window.setInterval(function () {
                                        count--;
                                        if(count>=0){
                                            oneself.text(count+"秒后从新发送");
                                        }else{
                                            window.clearInterval(time);
                                            oneself.text("从新发送");
                                            oneself.attr("disabled",false);
                                        }
                                    },1000);
                                }else{
                                    $.messager.popup(data.msg);
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body el-account">
                            ...
                            <div class="row h4 account-info">
                                <div class="col-sm-4">
                                    账户总额：<span class="text-primary">${account.sumAmount}元</span>
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="row h4 account-info">
                                <div class="col-sm-4">
                                    体验金余额：<span class="text-primary">${expaccount.usableAmount}元</span>
                                </div>
                                <div class="col-sm-4">
                                    体验金冻结金额：<span class="text-primary">${expaccount.freezedAmount}元</span>
                                </div>
                                <div class="col-sm-4">
                                    未回收体验金：<span class="text-primary">${expaccount.unReturnExpAmount}元</span>
                                </div>
                            </div>

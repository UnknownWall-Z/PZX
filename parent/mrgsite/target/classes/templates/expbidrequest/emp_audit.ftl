	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post" action="/expBid_audit_list">
				...
				<div class="panel panel-default">
					<table class="table">
						...
						<#list pageResult.listData as data>
							<tr>
								<td>
									<a target="_blank" href="/expBorrow_info?id=${data.id}">${data.title}</a>&emsp;<span class="label label-primary">信</span>
								</td>
		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
		      <div class="modal-body">
		      	<form class="form-horizontal" id="editform" method="post" action="/expBid_auditI">
					<fieldset>
						<div id="legend" class="">
							<legend>满标x审</legend>
						</div>

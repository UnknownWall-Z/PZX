<ul id="menu" class="list-group">
    ...
    <li class="list-group-item">
        <a href="#" data-toggle="collapse" data-target="#exmoney_detail">
            <span>活动</span>
        </a>
        <ul class="in" id="exmoney_detail">
            <li class="expPublish"><a href="/expPublish">体验金发布</a></li>
            <li class="expManage"><a href="/expBidRequest_list">体验金管理</a></li>
            <li class="expAudit"><a href="/expBid_audit_list">体验金招标</a></li>
        </ul>
    </li>
	...
	<li class="list-group-item">
		...
		<ul class="in" id="auditmanage_detail">
			...
			<li class="bidrequest_auditX_list"><a href="/bidrequest_auditX_list">满标x审</a></li>

...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-3">
				<#assign currentMenu="bidrequest_auditX_list" />
					...
					<table class="table">
						...
						<#list pageResult.listData as data>
							<tr>
								<td>
									<#if data.hasExpType>
									<a target="_blank" href="/expBorrow_info?id=${data.id}">${data.title}</a>&emsp;<span class="label label-primary">活动</span>
									<#else>
		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
		      <div class="modal-body">
		      	<form class="form-horizontal" id="editform" method="post" action="/bidrequest_audit">
					<fieldset>
						<div id="legend" class="">
							<legend>满标x审</legend>
						</div>

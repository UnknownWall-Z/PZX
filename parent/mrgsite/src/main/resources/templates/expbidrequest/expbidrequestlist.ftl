				...
				<div class="panel panel-default">
					<table class="table">
						...
						<#list pageResult.listData as data>
							<tr>
								<td>
									<a target="_blank" href="/expBorrow_info.?id=${data.id}">${data.title}</a>&emsp;<span class="label label-primary">体</span>
								</td>
